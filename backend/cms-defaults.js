...
export const CMS_DEFAULTS = {
  home: {
    hero: {
      ...
      subtitle: "Explore breathtaking destinations worldwide with Caledor DMC — bespoke hotel bookings, transfers, and curated holiday packages across the UK & Europe.",
      primary_cta_label: "Become a Partner",
      primary_cta_url: "#contact",
      secondary_cta_label: "Explore Destinations",
      secondary_cta_url: "#destinations",
      background_image: "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1920&q=85",
    ...
    featured_tours: {
      enabled: "1",
      section_title: "Our Popular Tours",
      section_subtitle: "Handpicked adventures for every traveler",
      tours_count: "6",
      tour_tags_json: JSON.stringify(["Scottish Highlands", "London Royal Escape", "Swiss Alps Experience"]),
    },
    why_choose: {
      enabled: "1",
      section_title: "Why Choose Caledor",
      features_json: JSON.stringify([
        { icon: "🧭", title: "Expert Guides", description: "Experienced local guides with deep knowledge of every destination." },
        { icon: "🛡", title: "Safe & Secure", description: "Your safety is our priority with 24/7 support throughout your journey." },
        { icon: "⭐", title: "Best Value", description: "Competitive pricing with no hidden fees and flexible payment options." },
      ]),
    },
    testimonials: {
      enabled: "1",
    ...
    packages_heading: {
      enabled: "1",
      kicker: "Our Packages",
      title: "Curated journeys across the UK and Europe",
      subtitle: "Every package below is managed from the admin panel and updates live on the website.",
    },
    blog_heading: {
    ...
    scotland_attractions: {
      ...
      title: "Iconic landscapes, wildlife, and experiences across Scotland.",
      items_json: JSON.stringify([
        { label: "Isle of Skye", image: "/uploads/scotland-attractions/isle-of-skye.png", alt: "Isle of Skye dramatic coastline", hero: true },
        { label: "Loch Lomond Cruise", image: "/uploads/scotland-attractions/loch-lomond-cruise.png", alt: "Loch Lomond cruise at sunrise", hero: false },
        { label: "The Kelpies", image: "/uploads/scotland-attractions/the-kelpies.png", alt: "The Kelpies sculptures at sunset", hero: false },
        { label: "Whisky Distillery", image: "/uploads/scotland-attractions/whisky-distillery.png", alt: "Scottish whisky distillery with copper stills", hero: false },
        { label: "Highland Wildlife", image: "/uploads/scotland-attractions/puffin-highlands.png", alt: "Atlantic puffin with wings spread", hero: false },
        { label: "Coastal Wildlife", image: "/uploads/scotland-attractions/puffin-fishing.png", alt: "Puffin carrying fish", hero: false },
        { label: "Scottish Seabirds", image: "/uploads/scotland-attractions/puffins-sea.png", alt: "Puffins floating on Scottish waters", hero: false },
      ]),
    },
    premium_services: {
      enabled: "1",
      ...
      items_json: JSON.stringify([
        { title: "Hotel Bookings", description: "Exclusive access to prestigious properties and boutique hotels with preferred partner benefits.", image: "/uploads/premium-services/premium-01-hotel.png", alt: "Luxury hotel lobby", link: "#contact" },
        { title: "Holiday Packages", description: "Carefully curated itineraries that blend iconic landmarks with hidden gems for a smoother journey.", image: "/uploads/premium-services/premium-02-holiday.png", alt: "Luxury chauffeur service in Paris", link: "#contact" },
        { title: "Sightseeing Tours", description: "Private, expert-led excursions with deep local context and access to cultural heritage sites.", image: "/uploads/premium-services/premium-03-sightseeing.png", alt: "Fine dining restaurant interior", link: "#contact" },
        { title: "Vehicle At Disposal", description: "A fleet of premium vehicles with professional chauffeurs for flexible, private travel.", image: "/uploads/premium-services/premium-04-vehicle.png", alt: "Travel itinerary planning on a desk", link: "#contact" },
        { title: "Airport Transfers", description: "Seamless, punctual, and comfortable transfers for a stress-free arrival and departure experience.", image: "/uploads/premium-services/premium-05-airport.png", alt: "Airport transfer with luxury car", link: "#contact" },
        { title: "Restaurant Reservations", description: "Priority booking at Michelin-starred establishments and sought-after dining destinations.", image: "/uploads/premium-services/premium-06-restaurant.png", alt: "Couple sightseeing near historic ruins", link: "#contact" },
      ]),
    },
    mice: {
      enabled: "1",
  ...
  "about-us": {
    ...
    story: {
      ...
      image_url: "/uploads/about/caledor-about-castle.png",
      stat_1_label: "Years",
      stat_1_value: "15+",
    ...
    team: {
      ...
      description: "Led by passionate travel specialists with deep destination knowledge.",
      show_more: "0",
      members_json: JSON.stringify([
        { name: "Mr. Amit Arking", role: "Managing Director", bio: "With deep knowledge of European operations, Amit leads our partner relationships, product design, and on-ground service quality.", photo: "https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=500&q=85", linkedin: "", twitter: "" },
        { name: "Ms. Mira Grewal", role: "Operations Director", bio: "Mira ensures each movement, hotel check-in, meal plan, and local experience is handled with care and calm precision.", photo: "https://images.unsplash.com/photo-1529421308418-eab98863cee4?auto=format&fit=crop&w=500&q=85", linkedin: "", twitter: "" },
      ]),
    },
    awards: {
      enabled: "1",
  ...
  contact: {
    ...
    info: {
      enabled: "1",
      address: "12, Waterfront Lane, London, United Kingdom - EC4A 1BB",
      phone_1: "+44 20 0000 0000",
      phone_2: "+44 20 0000 0001",
      email_1: "info@caledor.com",
      email_2: "support@caledor.com",
  ...
  blog: {
    page: {
      enabled: "1",
      title: "Travel Blog",
      subtitle: "Your Daily Adventures",
      background_image: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=1920&q=85",
      description: "Editorial perspectives on destinations, trends, and travel planning across the UK and Europe.",
    },
    listing: {
      enabled: "1",
      posts_per_page: "6",
  ...
  "packages-page": {
    ...
    categories: {
      ...
      show_all_tab: "1",
      items_json: JSON.stringify([
        { name: "Adventure & Trekking", slug: "adventure", count: "18", visible: true },
        { name: "Beach & Island", slug: "beach", count: "12", visible: true },
        { name: "Cultural & Heritage", slug: "cultural", count: "9", visible: true },
        { name: "Wildlife & Safari", slug: "wildlife", count: "7", visible: true },
        { name: "Honeymoon", slug: "honeymoon", count: "11", visible: true },
        { name: "Family Tours", slug: "family", count: "8", visible: true },
      ]),
    },
    cta: {
      enabled: "1",
    ...
    navigation: {
      ...
      columns_json: JSON.stringify([
        ...
        },
        {
          title: "Company",
          links: [
            { label: "About Us", url: "#aboutSection" },
            { label: "Blog", url: "#blogSection" },
            { label: "FAQ", url: "#faq" },
